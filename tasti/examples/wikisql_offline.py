...
ROOT_DATA_DIR = '/home/steven/Documents/511/WikiSQL/data'
...
class WikiSQLSUPGRecallQuery(tasti.SUPGPrecisionQuery):
    def score(self, target_dnn_output):
        return 1.0 if target_dnn_output[0] == 0 else 0.0
...
if __name__ == '__main__':
    ...
    # result = query.execute_metrics(err_tol=0.5, confidence=0.5)
    # print(result)
